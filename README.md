...
در حالت پیشفرض فایل ها در پوشه `0000` ذخیره می شوند. عنوان این فایل را با سال جاری جایگزین کنید، مثلا 1404. این مسیر را در دو پلاگین بالا هم اصلاح کنید. (به این ترتیب برای هر سال یک پوشه مجزا خواهید داشت)
<br>
...
**زنجیره(chain):** اگر نخواستید میتونید مقدارش را `null` تنظیم کنید.
