...
> ⚠️ با توجه به توسعه پلاگین Habit Tracker Dashboard این تمپلیت دیگر به‌روزرسانی نخواهد شد. پیشنهاد می‌کنم برای تجربه بهتر و امکانات بیشتر، از پلاگین [Habit Tracker Dashboard](https://github.com/fardm/Habit-Tracker-Dashboard) استفاده کنید
...
5. در سایدبار راست، تقویم قابل مشاهده است. با کلیک روی روزها: یادداشت روزانه ایجاد می‌شود، و با کلیک روی هفته/ماه/فصل/سال: گزارش هفتگی، ماهانه یا سالانه ساخته می‌شود.
